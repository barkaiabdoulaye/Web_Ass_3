...
<div class="project-details">
    ...
    <div class="dashboard-actions">
        <a href="/sme_stack/index.php?url=admin/projects" class="btn btn-secondary">Back to Projects</a>
        <a href="/sme_stack/index.php?url=admin/dashboard" class="btn btn-primary">Dashboard</a>
    </div>
</div>
